...
from .output_types.fidc.bemol import RelatorioFIDCBemol
from .output_types.fidc.brz_consignados_v import RelatorioFIDCBRZConsignadosV
from .output_types.fidc.icred import RelatorioFIDCICred, RelatorioFIDCICredImage
from .output_types.fidc.sol_agora_iii import RelatorioFIDCSolAgoraIII
from .output_types.fidc.somacred import RelatorioCompletoSomacred, RelatorioCompletoSomacredImage
from .output_types.fidc.valora_alion_ii import (
    RelatorioFIDCValoraAlion,
    RelatorioFIDCValoraAlionIIImage,
)
from .output_types.fidc.valora_noto import RelatorioFIDCNotoImage, RelatorioFIDCValoraNoto
from .output_types.fidc.verde_card import RelatorioFIDCVerdeCard
...
class ModelSchemaEnum(Enum):
    ...
    icred_image = RelatorioFIDCICredImage
    sol_agora_iii = RelatorioFIDCSolAgoraIII
    somacred = RelatorioCompletoSomacred
    somacred_image = RelatorioCompletoSomacredImage
    valora_alion_ii = RelatorioFIDCValoraAlion
    valora_alion_ii_image = RelatorioFIDCValoraAlionIIImage
    valora_noto = RelatorioFIDCValoraNoto
    valora_noto_image = RelatorioFIDCNotoImage
